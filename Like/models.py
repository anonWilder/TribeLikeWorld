...
class Item(models.Model):
    ...
    sku = models.CharField(max_length=300, default='none')
    in_stock = models.BooleanField(default=True)
    stock_quantity = models.IntegerField(max_length=2000, default=0)
    stock_status = models.CharField(max_length=300, default='instock')
    barcode = models.CharField(max_length=900, default='none')
    size = models.CharField(max_length=900, default='none')
    size_name = models.CharField(max_length=900, default='none')
    weight = models.CharField(max_length=300, default='none')
    image_link = models.BooleanField(default=False)
    image0 = models.CharField(max_length=200,blank=True,null=True,default="/static/images/banner3.png")
    image1 = models.CharField(max_length=200,blank=True,null=True,default="/static/images/banner3.png")
    image2a = models.CharField(max_length=200,blank=True,null=True,default="/static/images/banner3.png")
    image3 = models.CharField(max_length=200,blank=True,null=True,default="/static/images/banner3.png")
